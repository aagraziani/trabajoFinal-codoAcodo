document.addEventListener("DOMContentLoaded", function () {
  ...
  function add_new_task(event) {
    ...
    let data = {
      nombre: document.querySelector("#Formulario #nombre-banda").value,
      fecha: document.querySelector("#Formulario #fecha-banda").value,
      genero: document.querySelector("#Formulario #genero-banda").value,
    };
  ...
  function add_or_update() {
    if (task_id !== null) {
      document.querySelector(".actionTitle").innerHTML =
